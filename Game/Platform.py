...
class Quest:
    ...
    def update(self, player):
        self.timeBeforeAnswer += 1
        keys = pygame.key.get_pressed()
        if keys[pygame.K_LEFT] or keys[pygame.K_a] and self.timeBeforeAnswer > 100:
            self.choose = 0
        if keys[pygame.K_RIGHT] or keys[pygame.K_d] and self.timeBeforeAnswer > 100:
            self.choose = 1
